...
#player #seekerBase{ border-color:#f0ccd5; }
#player #seekerBuffered{ background-color:#ecd3ff; }
#player #seekerSliderBase{ background-color:#f0ccd5; }

#player #volume{ width:70px; right:33px; }
#player #volumeSlider{ width:14px; background:url(sizerAndVol.png); }

#playlist,#playlist .module,#playlist h3{ border-color:#7f23c8; color:#f0ccd5; }
#playlist h3{ background-color: #f0ccd5; color:#FFF;}
#playlist .even{background-color:#FFF;}
#playlist .odd{ background-color:#ecd3ff;}
#playlist .focus{ background-color:#f0ccd5; color:#FFF;}
